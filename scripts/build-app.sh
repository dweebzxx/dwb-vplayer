...
DIST_APP_PATH="$DIST_DIR/dwb xtreme.app"
BUILD_INFO_PATH="$DIST_DIR/dwb-xtreme-app-build-info.txt"
TMP_ROOT="${TMPDIR:-/tmp}/dwb-xtreme-app-build"
BUILD_SETTINGS_FILE="$(mktemp "${TMPDIR:-/tmp}/dwb-xtreme-build-settings.XXXXXX")"
